...
//  ERScreenRecord
//
//  Created by Mahmudul Hasan on 2020/3/26.
...
class ViewController: UIViewController {
    ...
    static let kBroadcastExtensionBundleId = "com.emraz.ERScreenRecord.Extension"
    static let kBroadcastExtensionSetupUiBundleId = "com.emraz.ERScreenRecord.ExtensionSetupUI"
...
extension ViewController: RPScreenRecorderDelegate {
    func screenRecorderDidChangeAvailability(_ screenRecorder: RPScreenRecorder) {
        if Thread.isMainThread {
            ...
            if (self.broadcastController == nil) {
                checkRecordingAvailability()
            }
        } else {
            DispatchQueue.main.async {
